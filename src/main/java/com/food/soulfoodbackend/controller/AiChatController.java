...
public class AiChatController {
    ...
    public ApiResult<List<AiConversationItemDto>> conversations(
        ...
        return ApiResult.ok(aiChatService.listConversations(UserContext.getUserId(), keyword, sceneTag));
    }

    @PatchMapping("/conversations/{conversationId}")
    public ApiResult<Map<String, String>> updateConversation(
            @PathVariable String conversationId,
            @RequestBody UpdateConversationRequest request) {
        aiChatService.updateConversation(
                conversationId,
                UserContext.getUserId(),
                request.getTitle(),
                request.getSceneTag());
        return ApiResult.ok(Map.of("conversationId", conversationId, "status", "updated"));
    }
